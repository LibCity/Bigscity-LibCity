...
def dataprocess():
    ...
    path = "D:/code/python/Bigscity-LibCity-master/libcity/model/traffic_accident_prediction/"
    p1 = pd.read_csv(path + "Dataset/" + "risk_seq.rel", usecols=[2, 3, 4])
    ...
    p_dyna = pd.read_csv(path + "Dataset/" + "risk_seq.dyna", usecols=[2, 3, 4, 5, 6, 7, 8])
    p_dyna2 = pd.read_csv(path + "Dataset/" + "risk_seq2.dyna", usecols=[2])

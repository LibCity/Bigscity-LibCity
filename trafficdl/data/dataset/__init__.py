...
from trafficdl.data.dataset.traffic_state_cpt_dataset import TrafficStateCPTDataset
...
from trafficdl.data.dataset.traffic_state_grid_od_dataset import TrafficStateGridOdDataset

...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # hidden = [layers * num_directions, batch_size, hidden_size]
        return hidden
...
class Seq2Seq(AbstractTrafficStateModel):
    ...
    def forward(self, batch):
        ...
        encoder_hidden_state = self.encoder(src)
        ...
        for i in range(self.output_window):
            ...
            # decoder_hidden_state = [layers * num_directions, batch_size, hidden_size]

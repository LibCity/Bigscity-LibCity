...
class SERM(AbstractModel):
    def __init__(self, config, data_feature):
        ...
        #lstm layer
        self.lstm = nn.LSTM(input_size = self.loc_emb_size + self.tim_emb_size + self.text_emb_size, hidden_size = self.hidden_size)
    ...
    def forward(self, batch):
        ...
        attrs_latent = torch.cat([loc_emb, tim_emb, text_emb], dim = 2).permute(1, 0, 2)#change batch*seq*emb_size to seq*batch*emb_size

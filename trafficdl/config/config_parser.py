...
class ConfigParser(object):
    ...
    def __init__(self, task, model, dataset, config_file=None, other_args=None):
        '''
        Args:
    ...
    def _parse_config_file(self, config_file):
        if config_file != None:
            ...
            if os.path.exists('./{}.json'.format(config_file)):
                ...
                raise FileNotFoundError('Config file {}.json is not found. Please ensure the config file is in the root dir and is a JSON file.'.format(config_file))

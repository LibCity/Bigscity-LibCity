...
def add_other_args(parser):
    for arg in general_arguments:
        if general_arguments[arg] == 'int':
            ...
            parser.add_argument('--{}'.format(arg), type=str2bool, default=None)
        elif general_arguments[arg] == 'float':
            parser.add_argument('--{}'.format(arg), type=str2float, default=None)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='foursquare_tky', help='the name of dataset')
    ...
    parser.add_argument('--train', type=str2bool, default=True, help='whether re-train model if the model is trained before')
    # 增加其他可选的参数
